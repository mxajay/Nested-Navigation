...
import {carousel, slider, stats} from './styles';
  ...
  return (
    <View style={[slider.slide]}>
      ...
      {item && typeof item != 'string' && (
        <View style={[slider.slideTextWrap, {}]}>
          <Text style={[slider.slideText, {}]}>{item.title}</Text>
        </View>
      )}
    </View>
  );
    ...
    <View style={[carousel.container, {}]}>
      {items && items.length > 0 ? (
        <Fragment>
          ...
          <View style={[carousel.bullets, {...props.bulletStyle}]}>
            {bullets}
          </View>
        </Fragment>
      ) : (
